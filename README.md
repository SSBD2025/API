...
```
cd existing_repo
git remote add origin https://gitlab.com/iitpl/ssbd/2025/02/api.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.com/iitpl/ssbd/2025/02/api/-/settings/integrations)
