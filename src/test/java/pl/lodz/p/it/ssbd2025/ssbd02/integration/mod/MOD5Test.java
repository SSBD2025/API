...
// CLIENTS VIEWS BLOOD TEST ORDER //
// CLIENTS VIEWS BLOOD TEST ORDER //
// CLIENTS VIEWS BLOOD TEST ORDER //
// PS
...
public class MOD5Test extends BaseIntegrationTest {
    ...
    @Test
    public void mod5_ok() throws Exception {
        mockMvc.perform(get("http://localhost:8080/api/mod/clients/blood-test-order")
    ...
    @Test
    public void mod5_unauthorized() throws Exception {
        mockMvc.perform(get("http://localhost:8080/api/mod/clients/blood-test-order")
                        .contentType(MediaType.APPLICATION_JSON))
    ...
    @Test
    public void mod5_forbidden() throws Exception {
        mockMvc.perform(get("http://localhost:8080/api/mod/clients/blood-test-order")
