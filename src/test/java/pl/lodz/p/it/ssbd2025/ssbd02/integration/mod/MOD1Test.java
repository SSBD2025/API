...
public class MOD1Test extends BaseIntegrationTest {
    @MockitoBean
    ...
    @Test
    public void getClientsWithoutSearchPhraseTest() throws Exception {
    ...
    @Test
    public void getClientsUnauthorizedTest() throws Exception {
        mockMvc.perform(get("/api/mod/dieticians/get-clients-by-dietician")
                .contentType(MediaType.APPLICATION_JSON))
