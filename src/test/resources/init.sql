...
GRANT SELECT, INSERT, UPDATE, DELETE ON TABLE blood_test_results TO ssbd02mod;
GRANT SELECT, INSERT, UPDATE, DELETE ON TABLE client_blood_test_reports TO ssbd02mod;
...
GRANT SELECT, INSERT, UPDATE, DELETE ON TABLE food_pyramid TO ssbd02mod;
