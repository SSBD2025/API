...
public class SurveyConsts {
    ...
    public static final String COLUMN_DIET_PREFERENCES = "diet_preferences";
    public static final String COLUMN_ACTIVITY_LEVEL = "activity_level";
    public static final String COLUMN_DRINKS_ALCOHOL = "drinks_alcohol";
    public static final String COLUMN_MEALS_PER_DAY = "meals_per_day";
    public static final String COLUMN_NUTRITION_GOAL = "nutrition_goal";
    public static final String COLUMN_MEAL_TIMES = "meal_times";
